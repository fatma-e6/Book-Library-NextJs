  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-white/60 backdrop-blur-sm rounded-2xl p-10 border border-[#E8DDD0] shadow-sm">
        <h1 className="text-3xl font-bold text-[#5C3D2E] mb-2 text-center">Welcome Back</h1>
        <p className="text-[#7C6355] text-center mb-8 text-sm">Enter your information below to login</p>
        <form onSubmit={handleSubmit(submitLogic)} className="flex flex-col gap-4">
          ...
          <p className="text-center text-sm text-[#7C6355]">
            Don&apos;t have an account? <Link href="/register" className="text-[#C17B4A] hover:underline font-medium">Register</Link>
          </p>
        </form>
      </div>
    </div>
